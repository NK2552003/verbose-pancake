...
export default function ProfileCard() {
  return (
    <motion.div
      className="absolute bottom-12 md:bottom-auto md:top-20 left-6 z-30 pointer-events-auto"
      initial={{ opacity: 0, y: -20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6 }}
    >
      <div className="bg-black/80 backdrop-blur-md border border-gray-700/50 rounded-xl p-4 max-w-xs">
